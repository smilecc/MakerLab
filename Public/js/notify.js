...
LEFT = 0;
RIGHT = 1;
LOADING = new notifyMode('am-icon-spinner am-icon-spin','info','Loading');
SUCCESS = new notifyMode('am-icon-info-circle','success','Success');
ERROR = new notifyMode('am-icon-warning','error','Error');
INFO = new notifyMode('am-icon-info-circle','info','Infomation');
