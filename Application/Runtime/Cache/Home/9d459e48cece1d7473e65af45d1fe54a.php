...
<script type="text/javascript">
	var nowType = <?php echo $nowType;?>;
	var nowProcess = <?php echo $nowProcess;?>;
	var nowPage = 0;
	...
	function RedirectPage(){
		window.location = "<?php echo U('/Home/Project/');?>?" + 'type=' + nowType + '&process=' + nowProcess;
	}
	function LoadNextPage(){
	  ...
	  $(id).load('<?php echo U("/Home/Project/load");?>?page=' + nowPage + '&type=' + nowType + '&process=' + nowProcess);
	}
</script>
